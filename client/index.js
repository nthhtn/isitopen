								...
								<ul className="nav-main">
									<li className="nav-main-item">
										<Link className="nav-main-link active" to="/restaurants">
											...
											<span className="nav-main-link-name">Restaurant</span>
										</Link>
									</li>
									<li className="nav-main-item">
										<Link className="nav-main-link active" to="/my-collections">
											<i className="nav-main-link-icon fa fa-list"></i>
											<span className="nav-main-link-name">Collection</span>
										</Link>
									</li>
								</ul>
							</div>
